...
SELECT name
FROM countrylanguage
WHERE language = 'Italian' AND countrycode != 'VA';
...
SELECT name
FROM city
WHERE countrycode = 'IT' AND name != 'Rome';
...
FROM city
WHERE name LIKE 'Mil%' AND name != 'Milan';
